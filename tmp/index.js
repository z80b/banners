(function () {
  ...
  /*#__PURE__*/
  function () {
    function BannerBase(el) {
      _classCallCheck(this, BannerBase);
  ...
  var Banner =
  /*#__PURE__*/
  function (_BannerBase) {
    _inherits(Banner, _BannerBase);
    ...
    function Banner(el) {
      ...
      _this.$el.addClass('lp-banner--ready');
  ...
  document.addEventListener('DOMContentLoaded', function (event) {
    var banner = new Banner('.lp-quiz-banner');
  }, false);
