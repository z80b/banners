(function () {
  ...
  __p+='<div class="ny-panorama-pick__body">\n  <img class="ny-panorama-pick__image" src="'+
  ((__t=( props.src ))==null?'':__t)+
  '"/>\n  <div class="ny-panorama-pick__text">'+
  ((__t=( props.text ))==null?'':__t)+
  '</div>\n  <a class="ny-panorama-pick__button">Посмотреть</a>\n</div>';
  return __p;
  };
  ...
  function (_Dom) {
    ...
    function Banner(el) {
      ...
      _this.visibleSlides = 4; //this.slideWidth = this.$el.clientWidth / this.visibleSlides;
      ...
      console.log('Banner:', _assertThisInitialized(_this));
    ...
    _createClass(Banner, [{
      ...
      value: function createSlides() {
        this.$container.style.width = "".concat(this.slidesCount / this.visibleSlides * 100, "%");
        this.slideWidth = 100 / this.slidesCount;
        var cropCanvas = document.createElement('canvas');
        var partWidth = this.imageWidth / 10;
        cropCanvas.width = this.imageWidth;
        cropCanvas.height = this.imageHeight;

        for (var slide, i = 0; i < this.slidesCount; i++) {
          cropCanvas.getContext('2d').drawImage(this.$image, 0, 0, this.imageWidth, this.imageHeight, i * this.partWidth, 0, this.partWidth, this.imageHeight);
          slide = document.createElement('img');
          slide.className = 'ny-panorama__slide';
          slide.style.width = "".concat(this.slideWidth, "%");
          slide.src = cropCanvas.toDataURL('image/jpg'); //slide.style.backgroundImage = `url(${cropCanvas.toDataURL('image/png')})`;
      ...
      value: function initPicks() {
        ...
        if ($picks && $picks.length) {
          for (var i = 0; i < $picks.length; i++) {
            ...
            $picks[i].style.top = "".concat(position[1], "px");
            $picks[i].style.left = "".concat(position[0], "px");
            $popup.style.top = "".concat(parseInt(position[1]) + 8, "px");
            $popup.style.left = "".concat(parseInt(position[0]) + 8, "px");
