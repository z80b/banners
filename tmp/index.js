(function () {
  ...
  var getMoscowTime = function getMoscowTime() {
    var dt = new Date();
  ...
  var getDate = function getDate() {
    ...
    return "".concat(dt.getFullYear(), "/").concat(two(dt.getMonth() + 1), "/").concat(two(dt.getDate()));
  };
  var two = function two(num) {
    return parseInt(num) > 9 ? num : "0".concat(num);
  };
  ...
  function (_Dom) {
    ...
    function BannerSlide(el, index) {
      ...
      var dt = _this.$el.dataset.actionDate.match(/(\d+).(\d+)\-(\d+).(\d+)/);
    ...
    _createClass(BannerSlide, [{
      ...
      value: function checkTime() {
        ...
        if (this.currentTime >= this.startTime && this.currentTime <= this.endTime) {
          ...
          addClass$1(this.$el, 'ny-calendar-slide--coming');
        } else {
          this.$el.removeAttribute('href');
          removeClass$1(this.$el, 'ny-calendar-slide--coming');
          removeClass$1(this.$el, 'ny-calendar-slide--started');
        }
      }
    }]);
  ...
  function (_Dom) {
    ...
    function Banner(el) {
      ...
      _this.$el.querySelectorAll('.ny-calendar__slide').forEach(function ($slide, index) {
        _this.slides.push(new BannerSlide($slide, index, _assertThisInitialized(_this)));
      });
