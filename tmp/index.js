  ...
  function (_Backbone$Model) {
    ...
    _createClass(QuizModel, [{
      ...
      value: function update(_data) {
        ...
        return jquery.post('/blackfriday/preparequestions/', data, this.updateHandler.bind(this));
      }
    }, {
      key: "updateHandler",
    ...
    _createClass(QuizStepView, [{
      ...
      value: function setRsultText(el, step, product) {
        ...
        switch (step) {
          ...
          case 1:
            text = "\u0421\u043A\u0438\u0434\u043A\u0430 \u043D\u0430 \u0442\u043E\u0432\u0430\u0440 ".concat(product.discount, " ").concat(this.currency());
            break;

          case 2:
            text = "\u0426\u0435\u043D\u0430 \u0442\u043E\u0432\u0430\u0440\u0430 ".concat(product.price, " ").concat(this.currency());
            break;
        }
