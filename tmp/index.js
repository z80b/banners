(function () {
  ...
  var waitEvent = function waitEvent(name, callback) {
  ...
  function (_Dom) {
    ...
    function Popup(el, pick) {
      var _this;

      _classCallCheck(this, Popup);

      _this = _possibleConstructorReturn(this, _getPrototypeOf(Popup).call(this, el));
      _this.$pick = pick;

      _this.$pick.addEventListener('click', _this.showPopup.bind(_assertThisInitialized(_this)));
  ...
  function (_Dom) {
    ...
    function Banner(el) {
      ...
      _this.initSlider(); // this.$el.addEventListener('click', this.hidePopups.bind(this), false);
    ...
    _createClass(Banner, [{
        ...
        if ($picks && $picks.length) {
          for (var i = 0; i < $picks.length; i++) {
            ...
            if (parseInt(position[1]) + 310 > this.$el.clientHeight) {
              $popup.style.top = "".concat(parseInt(position[1]) - 310 + 8, "px");
            } else $popup.style.top = "".concat(parseInt(position[1]) + 8, "px");
      ...
      key: "hidePopups",
      value: function hidePopups() {
        var $popups = this.$el.querySelectorAll('.ny-panorama-popup');
