(function () {
  ...
  function (_Backbone$View) {
    _inherits(QuizResultView, _Backbone$View);

    function QuizResultView(props) {
      var _this;

      _classCallCheck(this, QuizResultView);

      _this = _possibleConstructorReturn(this, _getPrototypeOf(QuizResultView).call(this, props));
      _this.tagName = 'div';
      return _this;
    }

    _createClass(QuizResultView, [{
      key: "initialize",
      ...
      value: function setClass(model) {
        ...
        for (var key in steps) {
          this.$(".lp-game__result-dot--".concat(parseInt(key) + 1)).toggleClass('lp-game__result-dot--success', steps[key]);
        }
      ...
      key: "restartQuiz",
      value: function restartQuiz(event) {
      ...
      key: "lookAnswers",
      value: function lookAnswers() {}
    }, {
      key: "className",
      get: function get() {
        return 'lp-game__slide lp-game__slide--result';
      }
    }, {
      key: "events",
      get: function get() {
  ...
  function (_Backbone$Model) {
    _inherits(QuizModel, _Backbone$Model);

    function QuizModel(props) {
      _classCallCheck(this, QuizModel);

      return _possibleConstructorReturn(this, _getPrototypeOf(QuizModel).call(this, props));
    }

    _createClass(QuizModel, [{
      key: "initialize",
      value: function initialize() {
      ...
      value: function update(_data) {
        var data = Object.assign({
          'sku1': this.get('sku1'),
          'sku2': this.get('sku2')
        }, _data); // return post('/blackfriday/preparequestions/', data, this.updateHandler.bind(this));

        return axios$1('/blackfriday/preparequestions/', data).then(this.updateHandler.bind(this)); //   let response = await fetch('/blackfriday/preparequestions/', {
        //     method: 'POST',
        //     headers: {
      ...
      key: "updateHandler",
      value: function updateHandler(response) {
      ...
      value: function checkResult() {
        ...
        var sku1 = this.get('sku1');
        var sku2 = this.get('sku2');
  ...
  function (_Backbone$Collection) {
    _inherits(QuizSteps, _Backbone$Collection);

    function QuizSteps(props) {
      var _this;

      _classCallCheck(this, QuizSteps);

      _this = _possibleConstructorReturn(this, _getPrototypeOf(QuizSteps).call(this, props));
      _this.currentStep = 0;
      return _this;
    }

    _createClass(QuizSteps, [{
      key: "initialize",
      value: function initialize() {
      ...
      value: function update(skus) {
        ...
        if (skus && skus.length) {
          ...
          try {
            for (var _iterator = skus[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              var _skus = _step.value;
              _skus = _skus.sort(function () {
        ...
        underscore.each(this.models, function (model, index) {
          var data = {};
        ...
        jquery.when.apply(jquery, defResult).done(function () {
          _this2.trigger('collection:ready');
        });
      }
    }, {
      key: "isReady",
      value: function isReady() {
        ...
        underscore(this.models).each(function (model) {
          if (model.status != 'ready') result = false;
        });
  ...
  function gameSlideTpl(props){
  var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
  __p+='<div class="lp-game__slide-body">\n  ';
   for (var sku in props.products) { 
  __p+='\n  <div  class="lp-game__slide-part" data-sku="'+
  ((__t=( sku ))==null?'':__t)+
  '">\n      <img\n          class="lp-game__slide-image"\n          src="//a.lmcdn.ru/pi/img389x562/'+
  ((__t=( props.products[sku].images[0] ))==null?'':__t)+
  ...
  /*#__PURE__*/
  function (_Backbone$View) {
    _inherits(QuizStepView, _Backbone$View);

    function QuizStepView(props) {
      var _this;

      _classCallCheck(this, QuizStepView);

      _this = _possibleConstructorReturn(this, _getPrototypeOf(QuizStepView).call(this, props));
      _this.tagName = 'div';
      return _this;
    }

    _createClass(QuizStepView, [{
      key: "initialize",
      value: function initialize() {
      ...
      key: "slideChecked",
      value: function slideChecked(event) {
      ...
      key: "showResult",
      value: function showResult(model) {
        var data = model.toJSON();

        if (data && data.products && data.products[data.sku1]) {
          if (data.result) {
            this.$el.find("[data-sku=\"".concat(data.answer, "\"]")).addClass('lp-game__slide-part--success');
            this.setRsultText(this.$el.find("[data-sku=\"".concat(data.answer, "\"] .js-quiz-result-text")), data.step, data.products[data.answer]);
          } else {
            if (data.answer == data.sku1) {
              this.$el.find("[data-sku=\"".concat(data.sku2, "\"]")).addClass('lp-game__slide-part--success');
              this.setRsultText(this.$el.find("[data-sku=\"".concat(data.sku2, "\"] .js-quiz-result-text")), data.step, data.products[data.sku2]);
            } else {
              this.$el.find("[data-sku=\"".concat(data.sku1, "\"]")).addClass('lp-game__slide-part--success');
              this.setRsultText(this.$el.find("[data-sku=\"".concat(data.sku1, "\"] .js-quiz-result-text")), data.step, data.products[data.sku1]);
            }
          }
        }
      }
      ...
      key: "setRsultText",
      value: function setRsultText(el, step, product) {
        var text = '';
        ...
        switch (step) {
          ...
          case 1:
            text = "\u0421\u043A\u0438\u0434\u043A\u0430 \u043D\u0430 \u0442\u043E\u0432\u0430\u0440 ".concat(product.discount, " ").concat(LMDA.country.currency);
            break;

          case 2:
            text = "\u0426\u0435\u043D\u0430 \u0442\u043E\u0432\u0430\u0440\u0430 ".concat(product.price, " ").concat(LMDA.country.currency);
            break;
        }
  ...
  /*#__PURE__*/
  function (_Backbone$Model) {
    _inherits(QuizResultModel, _Backbone$Model);

    function QuizResultModel(props) {
      _classCallCheck(this, QuizResultModel);

      return _possibleConstructorReturn(this, _getPrototypeOf(QuizResultModel).call(this, props));
    }

    _createClass(QuizResultModel, [{
      key: "initialize",
      value: function initialize() {
      ...
      key: "updateResult",
      value: function updateResult(model) {
        var steps = this.get('steps');
        steps[model.get('step')] = model.get('result');
        this.set('steps', steps);
        this.set('result', this.attributes.steps.every(function (val) {
          return val;
        }));
  ...
  /*#__PURE__*/
  function (_Backbone$View) {
    _inherits(LpFormView, _Backbone$View);

    function LpFormView(props) {
      _classCallCheck(this, LpFormView);

      return _possibleConstructorReturn(this, _getPrototypeOf(LpFormView).call(this, props));
    }

    _createClass(LpFormView, [{
      key: "initialize",
      value: function initialize() {
      ...
      value: function parseForm() {
        return this.$el.find(':input[type=text], :input[type=email], :input[type=hidden]').get().reduce(function (res, el) {
      ...
      key: "verifyField",
      value: function verifyField(el) {
        switch (jquery(el).attr('data-type')) {
          case 'email':
            if (!el.value) {
      ...
      value: function verifyForm() {
        ...
        var formValid = true;
        this.$el.find(':input[data-type]').each(function (key, $input) {
          if (formValid) formValid = _this.verifyField($input);
        });
        return formValid;
      }
    }, {
      ...
      value: function submitForm(event) {
        ...
        if (this.verifyForm()) {
          ...
          jquery.post(this.$el.attr('action'), this.parseForm()).done(function (response) {
            if (response) {
              if (response.status.match(/ok/i)) {
                _this2.showSuccess(response);
              } else _this2.showError(response);
            } else _this2.showError('Что-то пошло не так. Попробуйте еще раз позднее.');
          }).error(this.showError);
        }
      }
    }, {
      key: "showError",
      value: function showError(message, el) {
        jquery(el).parent().addClass('field-error').find('.form__error').text(message).show();
      }
    }, {
      key: "resetError",
      value: function resetError(event) {
        var el = event.currentTarget;
        jquery(el).parent().removeClass('field-error').find('.form__error').text('');
      }
    }, {
      key: "showSuccess",
      value: function showSuccess(response) {}
    }, {
      key: "events",
      get: function get() {
        return {
  ...
  var QuizResultFormView =
  /*#__PURE__*/
  function (_LpFormView) {
    _inherits(QuizResultFormView, _LpFormView);

    function QuizResultFormView(props) {
      _classCallCheck(this, QuizResultFormView);

      return _possibleConstructorReturn(this, _getPrototypeOf(QuizResultFormView).call(this, props));
    }

    _createClass(QuizResultFormView, [{
      key: "showError",
      value: function showError(message, el) {
        if (this.$el.data('factor') == 'desktop') {
          _get(_getPrototypeOf(QuizResultFormView.prototype), "showError", this).call(this, message, el);
        } else {
    ...
    return QuizResultFormView;
  }(LpFormView);

  var QuizView =
  /*#__PURE__*/
  function (_Backbone$View) {
    _inherits(QuizView, _Backbone$View);

    function QuizView(props) {
      _classCallCheck(this, QuizView);

      return _possibleConstructorReturn(this, _getPrototypeOf(QuizView).call(this, props));
    }

    _createClass(QuizView, [{
      key: "initialize",
      value: function initialize() {
        var _this = this; //this.skus = this.$('[name=quiz]').map((ix, el) => { return [el.value.split(',')] }).get();


        this.skus = underscore.map(this.el.dataset, function (val) {
          return val.split(',');
      ...
      value: function render() {
        ...
        underscore(this.collection.models).each(function (model, index) {
          model.set('step', index);
          var quizStepView = new QuizStepView({
            id: 'qwiz-step-' + index,
            model: model
          });
          var quizStepElement = quizStepView.render();

          _this2.$('.js-game-slider').append(quizStepElement);
        });

        var quizResultView = new QuizResultView({
          model: this.quizResultModel
        });
        this.$('.js-game-slider').append(quizResultView.render());
        this.resultForm = new QuizResultFormView({
          el: '.js-quiz-form'
        });
      }
    }, {
      ...
      value: function goNextStep() {
        var step = parseInt(this.$('.lp-game').attr('data-step')) + 1;
        if (step < 4) this.$('.lp-game').attr('data-step', step);
      }
    }, {
      key: "goPrevStep",
      value: function goPrevStep() {
        var step = parseInt(this.$('.lp-game').attr('data-step')) - 1;
      ...
      key: "onAnswered",
      value: function onAnswered(model) {
        var currentStep = model.get('step');
      ...
      value: function restartQuiz() {
        ...
        this.collection.update(underscore.map(this.el.dataset, function (val) {
          return val.split(',');
        }));
      }
    }, {
