...
eval("// extracted by mini-css-extract-plugin\n\n//# sourceURL=webpack:///./src/css/index.styl?");
...
eval("module.exports = function anonymous(locals, escape, include, rethrow) {\n    escape = escape || function(_) {\n        return _ == undefined ? \"\" : String(_).replace(_MATCH_HTML, encode_char);\n    };\n    var _ENCODE_HTML_RULES = {\n        \"&\": \"&amp;\",\n        \"<\": \"&lt;\",\n        \">\": \"&gt;\",\n        '\"': \"&#34;\",\n        \"'\": \"&#39;\"\n    }, _MATCH_HTML = /[&<>'\"]/g;\n    function encode_char(_) {\n        return _ENCODE_HTML_RULES[_] || _;\n    }\n    var __output = [], __append = __output.push.bind(__output);\n    with (locals || {}) {\n        __append('<div class=\"page__content\">\\n  <h1 class=\"page__title\">');\n        __append(escape(title));\n        __append(\"</h1>\\n</div>\");\n    }\n    return __output.join(\"\");\n}\n\n//# sourceURL=webpack:///./src/tpl/page.html?");
